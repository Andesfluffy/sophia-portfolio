    ...
    <header className="sticky top-0 z-50 border-b border-line bg-ink/70 backdrop-blur-md">
      <nav className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-5 py-4 sm:px-8">
        <a href="#home" className="flex items-center gap-2 text-sm font-semibold tracking-wide">
          <span className="text-accent">{"✳︎"}</span> {model.firstName}
        </a>

        <a
          href="#contact"
          className="hidden items-center gap-2 rounded-full border border-line bg-card px-4 py-2 text-[11px] uppercase tracking-[0.15em] text-bone/80 transition-colors hover:border-accent/60 sm:flex"
        >
